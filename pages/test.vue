...
<template>
  <div
    class="relative overflow-hidden before:absolute before:top-1/2 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/component/hyperdrive.svg')] before:bg-no-repeat before:bg-center before:w-full before:h-96 before:-z-[1] before:transform before:-translate-y-1/2 before:-translate-x-1/2 dark:before:bg-[url('https://preline.co/assets/svg/component/hyperdrive.svg')]"
  >
    <div
      class="max-w-3xl mx-auto relative text-center px-4 sm:px-6 lg:px-8 py-10 md:py-24"
    >
      <div
        class="inline-block bg-gradient-to-tl from-blue-600 via-transparent to-purple-400 p-px rounded-xl mb-3"
      >
        <div
          class="bg-white rounded-xl py-1.5 px-6 text-3xl font-bold md:text-4xl lg:text-5xl lg:leading-tight dark:bg-neutral-900"
        >
          <span
            class="bg-clip-text bg-gradient-to-tl from-blue-600 to-purple-400 text-transparent"
          >
            5
          </span>
        </div>
      ...
      <h1
        class="text-3xl font-bold md:text-4xl lg:text-5xl lg:leading-tight dark:text-white"
      >
        Templates
      </h1>
      <p class="mt-4 md:text-lg text-gray-600 dark:text-neutral-400">
        Free, ready-to-use Tailwind CSS templates to build your projects at
        lightning speed, perfect for anyone looking to save time without
        sacrificing quality.
      </p>
    </div>
  </div>
  ...
  <div class="w-full max-w-2xl mx-auto pt-10 md:pt-16 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-10 sm:mt-14">
      ...
      <!-- Grid -->
      <div
        class="grid grid-cols-1 sm:grid-cols-2 gap-x-3 border-y border-gray-200 divide-y sm:divide-y-0 sm:divide-x divide-gray-200 dark:border-neutral-700 dark:divide-neutral-700"
      >
        <div class="sm:-ms-4 py-6 sm:px-4">
          ...
          <blockquote>
            <span class="text-sm text-gray-800 dark:text-neutral-200"
              ...
              that we will be a return customer.</span
            >
        ...
        <div class="group relative flex gap-x-5">
          ...
          <div class="grow pb-8 group-last:pb-0">
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">
              ...
              becoming a big company but it's still private, so the culture is
              as good as it gets at 1,000+ employees if you ask me. Managers are
    ...
    <div class="my-10 sm:my-14">
      ...
      <ul class="space-y-10">
        <li>
          <p class="mb-2 text-sm text-gray-500 dark:text-neutral-500">2024</p>
        ...
        <li>
          <p class="mb-2 text-sm text-gray-500 dark:text-neutral-500">2023</p>
          <h5 class="font-medium text-sm text-gray-800 dark:text-neutral-200">
